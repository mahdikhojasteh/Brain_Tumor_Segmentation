...
class TPR_D_Unet(nn.Module):
    def __init__(self, in_channel=4, out_channel=4):
        super().__init__()
        self.max_pool = nn.MaxPool2d(kernel_size=2, stride=2)

        self.down1 = DoubleConv2d(in_channel, 16)
        self.down2 = DoubleConv2d(16, 32)
        self.down3 = DoubleConv2d(32, 64)

        self.bottle_neck = DoubleConv2d(64, 128)

        self.up1 = TPR_Block(128, 64)
        self.up2 = TPR_Block(64, 32)
        self.up3 = TPR_Block(32, 16)
...
if __name__ == "__main__":
    net = TPR_D_Unet(in_channel=4, out_channel=4)
